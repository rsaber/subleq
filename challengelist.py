...
{
        'id' : 1,
        'text' : 'Your first challenge is to write a program that adds two numbers together. The input is at address 0 and 1 and the result must be stored at address 1',
        'tests' : [
            # Test Case
            [
